...
export const RESORT_INFO = {
  ...
  'Red River': {
    emoji: '🌯',
    vibe: 'Pueblito tranquilo con mucha cultura hispana. Resort pequeño, ideal para principiantes y familias.',
    temporada: 'Nov — Mar',
    salario: '$13–$16/hr',
    housing: 'La empresa a menudo ofrece housing, pero Red River es pequeño — también hay opciones en el pueblo.',
    ciudad_cercana: 'Taos (30 min) / Santa Fe (2h)',
    nieve: 'Buena — típico de New Mexico a 8,000+ pies de altura.',
    dificultad_wt: 'Baja — ideal para primeras veces',
    trabajos: ['Lift Operator', 'F&B', 'Ski Rental', 'Housekeeping'],
    tips: [
      'Red River es un pueblo artistico con mucha gastronomía local.',
